 ...
 * @author Sijin
 */
public class StopNotifier extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ca.stopAllInstances(containerid)) {

                json = jc.createSimpleJSON(true, "Stop APP [Stop APP Success]");


            } else {
                json = jc.createSimpleJSON(false, "Stop APP [Stop APP failed]");
